...
<div id="confirmationModal" class="modal fade @if (!$isFrontend)  @endif" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog  modal-dialog-centered " role="document">
        <div class="modal-content">
            <form method="POST">
                @csrf
                <div class="modal-body  @if (!$isFrontend) py-4 px-5 @else p-5 @endif">
                    <div class="text-center mb-4 @if ($isFrontend) px-4 @endif">
                        <h1 class=" text--warning  @if (!$isFrontend) mb-0 @else mb-2 @endif"><i class="la la-warning"></i></h1>
                    ...
                    <div class="d-flex gap-3 flex-wrap pt-2 pb-3">
                        ...
                        <div class="flex-fill">
                            <button type="submit"
                                class="btn w-100   @if (!$isFrontend) btn-large  btn--primary @else btn--base @endif">
