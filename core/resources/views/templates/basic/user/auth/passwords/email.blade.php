    ...
    <main class="page-wrapper">
        <section class="account">
            <div class="account-content bg-img"
                ...
                <div class="account-header mx-420 text-center">
                    ...
                    <div class="account-heading mb-2 text-center">
                        ...
                        <p class="account-heading__subtitle">@lang('Enter your email or username to start the account recovery process.')</p>
                    </div>
                </div>
                <div class="account-body">
                    <form method="POST" action="{{ route('user.password.email') }}" class="account-form verify-gcaptcha">
                        ...
                        <div class="row gy-3">
                            <div class="col-12">
                                <div class="input-group-custom">
                                    ...
                                    <div class="input-group-custom__wrapper">
                                        <label class="custom-form-label" for="value">@lang('Email or Username')</label>
                                        <input class="input-group-custom__input form--control" type="text"
                                            placeholder="@lang('Username or Email')" name="value" value="{{ old('value') }}"
                                            required id="value" autofocus="off">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <button class="w-100 btn btn--base" type="submit">@lang('Submit')</button>
                            </div>
