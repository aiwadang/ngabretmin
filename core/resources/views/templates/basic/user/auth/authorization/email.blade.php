                ...
                <div class="account-header mx-420">
                    ...
                    <div class="account-heading mb-2 text-center">
                        ...
                        <p class="account-heading__subtitle">
                            @lang('A 6-digit verification code has been sent to') {{ showEmailAddress(auth()->user()->email) }}
                        </p>
                    </div>
                </div>

                <div class="account-body">
                    <form method="POST" action="{{ route('user.verify.email') }}" class="account-form submit-form">
                        @csrf
