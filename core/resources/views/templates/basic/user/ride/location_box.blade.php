    ...
    <div class="booking-location-box__form">
        <div class="booking-location-box__inner">
            <div class="input-group-custom">
                <span role="button"
                    class="input-group-custom__icon currentLocationBtn {{ $runningRide ? 'disabled' : '' }}">
                ...
                <div class="input-group-custom__wrapper">
                    <input type="text" class="input-group-custom__input form--control" id="pickup_location_input"
                        placeholder="@lang('Enter pickup location')" value="{{ $pickup['location'] ?? '' }}" autocomplete="off">
                ...
                <div class="location__icon location-icon-pickup text--base">
                    @if ($pickup['location'])
                        <svg class="icon-fetch d-none" width="20" height="20" viewBox="0 0 24 24" fill="none"
                            aria-label="Auto-fill my location" class="pe-location-fetch css-bOZeEP" role="button"
                            tabindex="0">
                            <path d="M10.5 13.5.5 11 21 3l-8 20.5-2.5-10Z" fill="currentColor"></path>
                        </svg>

                        <svg class="icon-clear" width="20" height="20" viewBox="0 0 24 24" fill="none"
                            role="button" tabindex="0">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                d="M1 12C1 5.9 5.9 1 12 1s11 4.9 11 11-4.9 11-11 11S1 18.1 1 12Zm3 0c0 4.4 3.6 8 8 8s8-3.6 8-8-3.6-8-8-8-8 3.6-8 8Zm8-2 3-3 2 2-3 3 3 3-2 2-3-3-3 3-2-2 3-3-3-3 2-2 3 3Z"
                                fill="currentColor"></path>
                        </svg>
                    @else
                        <svg class="icon-fetch" width="20" height="20" viewBox="0 0 24 24" fill="none"
                            aria-label="Auto-fill my location" class="pe-location-fetch css-bOZeEP" role="button"
                            tabindex="0">
                            <path d="M10.5 13.5.5 11 21 3l-8 20.5-2.5-10Z" fill="currentColor"></path>
                        </svg>

                        <svg class="icon-clear d-none" width="20" height="20" viewBox="0 0 24 24" fill="none"
                            role="button" tabindex="0">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                d="M1 12C1 5.9 5.9 1 12 1s11 4.9 11 11-4.9 11-11 11S1 18.1 1 12Zm3 0c0 4.4 3.6 8 8 8s8-3.6 8-8-3.6-8-8-8-8 3.6-8 8Zm8-2 3-3 2 2-3 3 3 3-2 2-3-3-3 3-2-2 3-3-3-3 2-2 3 3Z"
                                fill="currentColor"></path>
                ...
                <ul class="search-input-dropdown__wrapper search-input-dropdown__wrapper-two" id="pickup_suggestions">
                </ul>
            </div>
            <div class="input-group-custom">
                ...
                <div class="input-group-custom__wrapper">
                    <input type="text" class="input-group-custom__input form--control"
                        id="destination_location_input" placeholder="@lang('Enter destination')"
                        value="{{ $destination['location'] ?? '' }}" autocomplete="off">
                ...
                <div class="location__icon location-icon-destination text--base">
                    <svg class="icon-clear {{ $destination['location'] ? '' : 'd-none' }}" width="20"
                        height="20" viewBox="0 0 24 24" fill="none" role="button" tabindex="0">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                            d="M1 12C1 5.9 5.9 1 12 1s11 4.9 11 11-4.9 11-11 11S1 18.1 1 12Zm3 0c0 4.4 3.6 8 8 8s8-3.6 8-8-3.6-8-8-8-8 3.6-8 8Zm8-2 3-3 2 2-3 3 3 3-2 2-3-3-3 3-2-2 3-3-3-3 2-2 3 3Z"
                            fill="currentColor"></path>
                    </svg>
                ...
                <ul class="search-input-dropdown__wrapper search-input-dropdown__wrapper-two"
                    id="destination_suggestions"></ul>
            </div>
        </div>
    </div>
</div>
