            ...
            <div class="col-xl-2 col-lg-2 col-md-3 col-6">
                <div class="footer-item with-menu">
                    ...
                    <ul class="footer-menu">
                        ...
                        <li class="footer-menu__item">
                            <a class="footer-menu__link" href="{{ route('how.to.work') }}">
                                <span class="text">@lang('How to work')</span>
                            </a>
                        </li>
                        <li class="footer-menu__item">
                            <a class="footer-menu__link" href="{{ route('driver.join') }}">
                                <span class="text">@lang('Join as Driver')</span>
                            </a>
                        </li>
                    </ul>
                </div>
