@php
    ...
    $defaultPlaceholder = asset('assets/images/default.png');
@endphp
            ...
            <div class="col-lg-6">
                <div class="feature-thumb">
                    <div class="feature-thumb__item">
                        <span class="feature-thumb__icon wow fadeIn" data-wow-duration="0.5s" data-wow-delay="0.5s">
                            <i class="fa-solid fa-arrow-right"></i>
                        </span>
                        <img class="wow fadeInDown" data-wow-duration="0.5s" data-wow-delay="0.5s"
                            src="{{ frontendImage('feature', @$featureContent->image_one, '672x300') }}"
                            alt="feature-image">
                    </div>
                    <div class="feature-thumb__item wow fadeInLeft" data-wow-duration="0.5s" data-wow-delay="0.5s">
                        <img src="{{ frontendImage('feature', @$featureContent->image_two, '324x300') }}"
                            alt="feature-image">
                    </div>
                    <div class="feature-thumb__item wow fadeInRight" data-wow-duration="0.5s" data-wow-delay="0.5s">
                        <img src="{{ frontendImage('feature', @$featureContent->image_three, '324x300') }}"
                            alt="feature-image">
                    </div>
                </div>
            </div>
                    ...
                    @foreach ($featureElements as $aboutElement)
                        <div class="feature-item">
                            ...
                            <div class="feature-item__content">
                                <h4 class="feature-item__title wow fadeInUp" data-wow-duration="0.5s"
                                    data-wow-delay="0.5s">
                                    {{ __(@$aboutElement->data_values->heading) }}
                                </h4>
                                <p class="feature-item__desc wow fadeInUp" data-wow-duration="0.6s"
                                    data-wow-delay="0.6s">
