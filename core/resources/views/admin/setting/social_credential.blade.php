            ...
            <div class="col-lg-4 col-sm-6">
                <x-admin.ui.card class="h-100">
                    <x-admin.ui.card.body class="position-relative">
                        ...
                        <div class="btn--group">
                            <button class="btn btn-outline--primary  editBtn" data-client_id="{{ $credential->client_id }}"
                            ...
                            @if (@$credential->status == Status::ENABLE)
                                <button class="btn btn-outline--danger  confirmationBtn" data-question="@lang('Are you sure that you want to disable this social login provider?')"
                                    data-action="{{ route('admin.setting.socialite.credentials.status.update', $key) }}">
                                    <i class="las la-eye-slash"></i> @lang('Disable')
                                </button>
                            @else
                                <button class="btn btn-outline--success  confirmationBtn" data-question="@lang('Are you sure that you want to enable this social login provider?')"
                                    data-action="{{ route('admin.setting.socialite.credentials.status.update', $key) }}">
            ...
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group ">
                        ...
                        <button type="button" class="input-group-text copyBtn" data-copy="" title="@lang('Copy')">
