                ...
                <div class="card-body">
                    <div class="user-detail">
                        <div class="user-detail__user">
                            ...
                            <x-permission_check permission="login riders">
                                <div class="login-user">
                                    <a target="_blank" href="{{ route('admin.rider.login', $user->id) }}"
                                        class="btn btn--primary">
                                        <i class="fas fa-sign-in-alt me-1"></i>
                                        <span>@lang('Login as Rider')</span>
                                    </a>
                                </div>
                            </x-permission_check>
                        </div>
    ...
    <div class="row responsive-row">
        ...
        <div class="col-xxl-3 col-sm-6">
            <x-admin.ui.widget.four url="{{ route('admin.rides.completed') }}?user_id={{ $user->id }}"
                :currency="false" variant="success" title="Completed Ride" :value="$widget['completed_ride']"
...
@push('breadcrumb-plugins')
    <div class=" d-flex gap-2  flex-wrap">
        ...
        <x-permission_check permission="view rider analysis">
            <a href="{{ route('admin.analysis.rider.analysis', $user->id) }}" class="flex-fill btn  btn--info">
                <i class="las la-chart-bar me-1"></i>@lang('Rider Analysis')
            </a>
        </x-permission_check>
    </div>
@endpush
