...
@section('panel')
    <div class="row responsive-row">
        ...
        <div class="col-xxl-3 col-sm-6">
            <x-admin.ui.widget.four url="{{ route('admin.rides.completed') }}?user_id={{ $user->id }}" :currency="false"
                variant="success" title="Completed Ride" :value="$widget['completed_ride']" icon="las la-check-double" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-admin.ui.widget.four url="{{ route('admin.rides.canceled') }}?user_id={{ $user->id }}" :currency="false"
    ...
    <div class="row responsive-row">
        ...
        <div class="col-xxl-3 col-sm-6">
            <x-admin.ui.widget.four url="{{ route('admin.reviews.rider',$user->id) }}" :currency="false" variant="warning" title="Average rating"
    ...
    <script>
        ...
        (function($) {
            ...
            const spentChart = (startDate, endDate) => {
                const url = @json(route('admin.analysis.rider.chart.spent', $user->id));
