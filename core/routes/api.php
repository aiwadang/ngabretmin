    ...
    Route::middleware(['auth:sanctum', 'token.permission:auth_token'])->group(function () {
        ...
        Route::middleware(['registration.complete', 'check.status'])->group(function () {
            ...
            Route::controller('UserController')->group(function () {
                ...
                Route::get('get-location-by-lat-lng', 'getLocationByLatLng');
                Route::get('search-address-by-location-name', 'searchAddressByLocationName');
                Route::get('get-place-details', 'getPlaceDetails');
                Route::get('get-direction', 'getDirection');
                Route::post('get-direction-by-route', 'getDirectionByRouteAPIV2');
            });
        ...
        Route::middleware('registration.complete')->group(function () {
            ...
            Route::middleware(['check.status'])->group(function () {
                ...
                Route::controller('DriverController')->group(function () {
                    ...
                    Route::get('vehicle-and-document-data', 'vehicleDocumentData');
                ...
                Route::middleware('driver.verification')->group(function () {
                    ...
                    Route::controller('RideController')->prefix('rides')->group(function () {
                        ...
                        Route::get('list', 'list')->withoutMiddleware('driver.verification');
                        Route::post('cancel/{id}', 'cancel');
